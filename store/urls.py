...
urlpatterns = [
    ...
    path('dashboard/products/<int:product_id>/colours/new/', dashboard_views.dashboard_product_add_color, name="dashboard-product-add-color"),
    path('dashboard/products/<int:product_id>/colours/', dashboard_views.dashboard_product_colors, name="dashboard-product-colors"),
    ...
    path('sale/', views.sale_products, name="sale-products"),
